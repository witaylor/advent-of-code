...
class Day04 : Day() {
    ...
    override fun partOne(inputLines: List<String>): String = splitToRanges(inputLines).count { pair ->
    ...
    override fun partTwo(inputLines: List<String>): String = splitToRanges(inputLines).count {
